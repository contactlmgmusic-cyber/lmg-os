  ...
  return (
    <main className="min-h-screen bg-black px-5 py-8 text-white md:px-10">
      <div className="mb-10">
        ...
        <p className="text-xs font-bold uppercase tracking-[0.28em] text-violet-400">Mon espace · Agenda</p>
        <h1 className="mt-3 text-4xl font-bold tracking-tight md:text-6xl">Mes événements</h1>
